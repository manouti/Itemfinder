...
public class RegisterEmailActivity extends AppCompatBase implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayNameEditText = (EditText) findViewById(R.id.display_name);
        ...
        mDisplayNameValidator = new RequiredFieldValidator((TextInputLayout)
                findViewById(R.id.display_name_layout));
    ...
    private void registerUser(String email, final String name, final String displayName, final String password) {
                            ...
                            updateTask
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful()) {
                                                updateUserInDatabase(firebaseUser, name, displayName);
    ...
    private void updateUserInDatabase(FirebaseUser firebaseUser, String name, String displayName) {
        DatabaseReference database = FirebaseDatabase.getInstance().getReference();
        DatabaseReference userReference = database.child("users").child(firebaseUser.getUid());
        User user = new User(firebaseUser.getUid(), name, displayName, null);
        userReference.updateChildren(user.toMap());
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button_create) {
            ...
            if (emailValid && passwordValid && nameValid && displayNameValid) {
                mActivityHelper.showLoadingDialog(R.string.progress_dialog_signing_up);
                registerUser(mEmailEditText.getText().toString(), mNameEditText.getText().toString(), mDisplayNameEditText.getText()
