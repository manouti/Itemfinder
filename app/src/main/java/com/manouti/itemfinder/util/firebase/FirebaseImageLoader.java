package com.manouti.itemfinder.util.firebase;
...
/**
 * TODO Add dependency to FirebaseUI Storage instead of copying this class.
 *
...
public class FirebaseImageLoader implements StreamModelLoader<StorageReference> {
    ...
    private static final String TAG = FirebaseImageLoader.class.getSimpleName();
